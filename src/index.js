/*! Timers plugin for litecanvas v0.1.0 by Luiz Bills | MIT Licensed */
...
pluginTimers.priority = 0 // run this plugin before other plugins

window.pluginTimers = pluginTimers
